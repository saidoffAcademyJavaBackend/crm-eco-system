...
public class NewsMapper {
    ...
    public News fromNewsCreateDtoToNews(NewsCreateDto newsCreateDto, List<Role> roles, Optional<Attachment> attachment) {
        News news = new News();
        news.setAttachment(attachment.orElse(null));
